...
if __name__ == "__main__":
    ...
    try:
        ...
        english_ancestors = {
            ...
            'ocr_ethnic': [],
            'cl_org_num_lvl': [],
            'min_recent_login_days': [],
            'bus_loan_cnt_lvl': [],
            'zx_occ_th2': [],
            'zx_empl_status': [],
            'last_5103_appl_time_to_date': [],
            'zx_occ_th1': [],
            'login_count_90d': [],
            'zx_job_title': [],
            'last_180_day_5103_appl_wdraw_refuse_cnt': [],
            'last_180_day_5103_loan_wdraw_cnt': []
        }
        # subGraph
        ...
        # 绘制英文因果图
        draw_causal_graph(english_ancestors, graphName='Agent_English_subgraph')
